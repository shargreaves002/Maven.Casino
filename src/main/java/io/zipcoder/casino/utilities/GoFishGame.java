...
public class GoFishGame implements Game{
        ...
        switch(lobby) {
            ...
            case 2:
                System.out.println("\n\nRULES:\n" +
                        ...
                        " hand, then you get all of their cards with that value.\n" +
                        "If guessed incorrectly the player must draw from the deck." +
                        " If you\ndraw from the deck, and if you draw a card with the" +
                        " number you asked for, you go again." +
                        "The game ends\nif either the deck, User Hand, or Computer" +
    ...
    private void playGoFish() {
        ...
        String again = yesNo();
        if (again.toLowerCase().equals("yes")) playGoFish();
    }
    ...
    private void checkBegginingDeal() {
        ...
        do {
            ...
            if(!win) {
                ...
                while(userHand.getCount(value) == 0) {
                    System.out.println("That Value isn't already contained in your hand, " +
    ...
    private static Scanner pauseScanner = new Scanner(System.in);
    private void pause() {
